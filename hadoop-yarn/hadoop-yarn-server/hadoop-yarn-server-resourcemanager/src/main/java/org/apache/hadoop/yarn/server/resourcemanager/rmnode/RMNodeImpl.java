...
public class RMNodeImpl implements RMNode, EventHandler<RMNodeEvent> {
  ...
  public static class StatusUpdateWhenHealthyTransition implements
    ...
    public NodeState transition(RMNodeImpl rmNode, RMNodeEvent event) {
      ...
      rmNode.setCpuUsagePercent(remoteNodeHealthStatus.getCpuUsagePercent());
      
      //float cpuReadTest = remoteNodeHealthStatus.getCpuUsagePercent();
      //LOG.info("cpu usage percent transfer succeeds, with Cpu Usage Percent:" + cpuReadTest);
