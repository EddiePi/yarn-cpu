...
public class FiCaSchedulerNode extends SchedulerNode{
  ...
  private ArrayList<String> colocatedNodes = new ArrayList<String>();
  ...
  //Edit by Eddie
  public void setServer(Map<String, String> nodeMapping) {
	  String nodeName = this.getNodeName();
	  server = nodeMapping.get(nodeName);
  }
  ...
  public void setColocatedNodes(Map<String, List<String>> nodesOnServer) {
	  List<String> nodeList = nodesOnServer.get(this.server);
	  if(nodeList != null) {
		  for(String node: nodeList) {
			  if(node != this.getNodeName()) {
				  colocatedNodes.add(node);
			  }
		  }
	  }
  }
  
  public ArrayList<String> getColocatedNodes() {
	  return colocatedNodes;
  }
}
